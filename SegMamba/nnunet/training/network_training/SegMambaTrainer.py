...
import torch
from nnunet.network_architecture.segmamba import SegMamba


class SegMambaTrainer(nnUNetTrainerV2):
    ...
    def initialize_network(self):
        ...
        self.network = SegMamba(self.num_input_channels, self.base_num_features, self.num_classes,
